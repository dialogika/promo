...
!(function (e, t) {
    ...
    var k =
        ((Observer.prototype.init = function init(e) {
            ...
            (te = se._dc = Ce.delayedCall(c || 0.25, function onStopFunc() {
            ...
            ((ScrollTrigger.prototype.init = function init(E, O) {
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), lt)) {
                    ...
                    if (
                        ...
                        (e = Va(_e) ? ob(_e, _t) : _t), (Y = Db("", a, be, he, e, 0)), (F = Db("", a, be, he, e, 0, Y)), (t = Y["" + he.op.d2]);
                        var u = J(z(be, "") || be);
                        (I = this.markerStart = Db("", a, u, he, e, t, 0, de)),
                            (L = this.markerEnd = Db("", a, u, he, e, t, 0, de)),
                    ...
                    if (
                                ...
                                if (ae && e && st) wb(ScrollTrigger, "scrollEnd", Ob);
                                    ...
                                    for (
                                        ...
                                        (u = (c = Tt[M]).pin) &&
                                            ...
                                            !de &&
                                            0 < c.end &&
                                            ((o = c.end - (Te._startClamp ? Math.max(0, c.start) : c.start)), ((u === ie && c.start - c._pinPush < B) || u === k) && isNaN(S) && (w += o * (1 - c.progress)), u === ae && (_ += o));
                                    if (
                                        ((B += w),
                                        (q += w),
                        ...
                        (Te.enable = function (e, t) {
                            Te.enabled ||
                                ((Te.enabled = !0), wb(be, "resize", Lb), me || wb(be, "scroll", Jb), Se && wb(ScrollTrigger, "refreshInit", Se), !1 !== e && ((Te.progress = Oe = 0), (D = R = Me = Ae())), !1 !== t && Te.refresh());
                        }),
